...
(cl:defmethod cl:initialize-instance :after ((m <SyncTimeDiff>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SyncTimeDiff)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<SyncTimeDiff> is deprecated: use autoware_msgs-msg:SyncTimeDiff instead.")))
