...
(cl:defclass <VscanTrackedArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obj_tracked
    :reader obj_tracked
    :initarg :obj_tracked
    :type (cl:vector autoware_msgs-msg:VscanTracked)
   :initform (cl:make-array 0 :element-type 'autoware_msgs-msg:VscanTracked :initial-element (cl:make-instance 'autoware_msgs-msg:VscanTracked))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <VscanTrackedArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VscanTrackedArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<VscanTrackedArray> is deprecated: use autoware_msgs-msg:VscanTrackedArray instead.")))
...
(cl:defmethod obj_tracked-val ((m <VscanTrackedArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:obj_tracked-val is deprecated.  Use autoware_msgs-msg:obj_tracked instead.")
  (obj_tracked m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VscanTrackedArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obj_tracked)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'autoware_msgs-msg:VscanTracked))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VscanTrackedArray>)))
  ...
  "autoware_msgs/VscanTrackedArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VscanTrackedArray)))
  "Returns string type for a message object of type 'VscanTrackedArray"
  "autoware_msgs/VscanTrackedArray")
