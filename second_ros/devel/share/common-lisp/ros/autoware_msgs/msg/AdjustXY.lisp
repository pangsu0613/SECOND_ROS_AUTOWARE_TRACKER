...
(cl:defmethod cl:initialize-instance :after ((m <AdjustXY>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AdjustXY)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<AdjustXY> is deprecated: use autoware_msgs-msg:AdjustXY instead.")))
