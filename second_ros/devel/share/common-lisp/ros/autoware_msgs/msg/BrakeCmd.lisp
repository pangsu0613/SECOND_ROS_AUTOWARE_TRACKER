...
(cl:defmethod cl:initialize-instance :after ((m <BrakeCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BrakeCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<BrakeCmd> is deprecated: use autoware_msgs-msg:BrakeCmd instead.")))
