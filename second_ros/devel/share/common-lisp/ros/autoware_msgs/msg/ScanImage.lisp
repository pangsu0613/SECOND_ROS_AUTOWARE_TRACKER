...
(cl:defmethod cl:initialize-instance :after ((m <ScanImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScanImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ScanImage> is deprecated: use autoware_msgs-msg:ScanImage instead.")))
