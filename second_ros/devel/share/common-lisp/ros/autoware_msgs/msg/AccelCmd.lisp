...
(cl:defmethod cl:initialize-instance :after ((m <AccelCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccelCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<AccelCmd> is deprecated: use autoware_msgs-msg:AccelCmd instead.")))
