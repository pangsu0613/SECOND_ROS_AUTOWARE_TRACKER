...
(cl:defmethod cl:initialize-instance :after ((m <PointsImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointsImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<PointsImage> is deprecated: use autoware_msgs-msg:PointsImage instead.")))
...
(cl:defmethod intensity-val ((m <PointsImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:intensity-val is deprecated.  Use autoware_msgs-msg:intensity instead.")
  (intensity m))

(cl:ensure-generic-function 'min_height-val :lambda-list '(m))
(cl:defmethod min_height-val ((m <PointsImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:min_height-val is deprecated.  Use autoware_msgs-msg:min_height instead.")
  (min_height m))
...
(cl:defmethod max_y-val ((m <PointsImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:max_y-val is deprecated.  Use autoware_msgs-msg:max_y instead.")
  (max_y m))

(cl:ensure-generic-function 'min_y-val :lambda-list '(m))
(cl:defmethod min_y-val ((m <PointsImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:min_y-val is deprecated.  Use autoware_msgs-msg:min_y instead.")
  (min_y m))

(cl:ensure-generic-function 'image_height-val :lambda-list '(m))
(cl:defmethod image_height-val ((m <PointsImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:image_height-val is deprecated.  Use autoware_msgs-msg:image_height instead.")
  (image_height m))

(cl:ensure-generic-function 'image_width-val :lambda-list '(m))
(cl:defmethod image_width-val ((m <PointsImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:image_width-val is deprecated.  Use autoware_msgs-msg:image_width instead.")
  (image_width m))
