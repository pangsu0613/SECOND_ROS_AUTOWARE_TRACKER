...
(cl:defmethod cl:initialize-instance :after ((m <ObjLabel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjLabel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ObjLabel> is deprecated: use autoware_msgs-msg:ObjLabel instead.")))
...
(cl:defmethod reprojected_pos-val ((m <ObjLabel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:reprojected_pos-val is deprecated.  Use autoware_msgs-msg:reprojected_pos instead.")
  (reprojected_pos m))
