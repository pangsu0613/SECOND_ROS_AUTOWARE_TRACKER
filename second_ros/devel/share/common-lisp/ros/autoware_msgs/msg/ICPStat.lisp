...
(cl:defmethod cl:initialize-instance :after ((m <ICPStat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ICPStat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ICPStat> is deprecated: use autoware_msgs-msg:ICPStat instead.")))
