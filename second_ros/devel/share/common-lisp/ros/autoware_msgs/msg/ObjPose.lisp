...
(cl:defmethod cl:initialize-instance :after ((m <ObjPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ObjPose> is deprecated: use autoware_msgs-msg:ObjPose instead.")))
