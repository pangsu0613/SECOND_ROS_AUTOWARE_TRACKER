...
(cl:defclass <ImageObj> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obj
    :reader obj
    :initarg :obj
    :type (cl:vector autoware_msgs-msg:ImageRect)
   :initform (cl:make-array 0 :element-type 'autoware_msgs-msg:ImageRect :initial-element (cl:make-instance 'autoware_msgs-msg:ImageRect))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ImageObj>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageObj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ImageObj> is deprecated: use autoware_msgs-msg:ImageObj instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ImageObj>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obj)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'autoware_msgs-msg:ImageRect))
