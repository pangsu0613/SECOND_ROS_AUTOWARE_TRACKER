...
(cl:defmethod cl:initialize-instance :after ((m <Signals>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Signals)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<Signals> is deprecated: use autoware_msgs-msg:Signals instead.")))
