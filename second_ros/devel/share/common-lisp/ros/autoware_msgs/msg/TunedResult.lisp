...
(cl:defclass <TunedResult> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (Red
    :reader Red
    :initarg :Red
    :type autoware_msgs-msg:ColorSet
    :initform (cl:make-instance 'autoware_msgs-msg:ColorSet))
   (Yellow
    :reader Yellow
    :initarg :Yellow
    :type autoware_msgs-msg:ColorSet
...
(cl:defmethod cl:initialize-instance :after ((m <TunedResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TunedResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<TunedResult> is deprecated: use autoware_msgs-msg:TunedResult instead.")))
...
(cl:defmethod Red-val ((m <TunedResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:Red-val is deprecated.  Use autoware_msgs-msg:Red instead.")
  (Red m))

(cl:ensure-generic-function 'Yellow-val :lambda-list '(m))
(cl:defmethod Yellow-val ((m <TunedResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:Yellow-val is deprecated.  Use autoware_msgs-msg:Yellow instead.")
  (Yellow m))

(cl:ensure-generic-function 'Green-val :lambda-list '(m))
(cl:defmethod Green-val ((m <TunedResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:Green-val is deprecated.  Use autoware_msgs-msg:Green instead.")
  (Green m))
