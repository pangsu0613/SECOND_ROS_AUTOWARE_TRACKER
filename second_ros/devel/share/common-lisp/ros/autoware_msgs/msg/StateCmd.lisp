...
(cl:defmethod cl:initialize-instance :after ((m <StateCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StateCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<StateCmd> is deprecated: use autoware_msgs-msg:StateCmd instead.")))
