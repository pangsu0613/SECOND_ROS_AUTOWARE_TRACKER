...
(cl:defmethod cl:initialize-instance :after ((m <IndicatorCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IndicatorCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<IndicatorCmd> is deprecated: use autoware_msgs-msg:IndicatorCmd instead.")))
