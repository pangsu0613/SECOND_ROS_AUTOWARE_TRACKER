...
(cl:defmethod cl:initialize-instance :after ((m <ImageLaneObjects>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageLaneObjects)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ImageLaneObjects> is deprecated: use autoware_msgs-msg:ImageLaneObjects instead.")))
...
(cl:defmethod lane_l_x1-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lane_l_x1-val is deprecated.  Use autoware_msgs-msg:lane_l_x1 instead.")
  (lane_l_x1 m))

(cl:ensure-generic-function 'lane_l_y1-val :lambda-list '(m))
(cl:defmethod lane_l_y1-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lane_l_y1-val is deprecated.  Use autoware_msgs-msg:lane_l_y1 instead.")
  (lane_l_y1 m))

(cl:ensure-generic-function 'lane_l_x2-val :lambda-list '(m))
(cl:defmethod lane_l_x2-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lane_l_x2-val is deprecated.  Use autoware_msgs-msg:lane_l_x2 instead.")
  (lane_l_x2 m))

(cl:ensure-generic-function 'lane_l_y2-val :lambda-list '(m))
(cl:defmethod lane_l_y2-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lane_l_y2-val is deprecated.  Use autoware_msgs-msg:lane_l_y2 instead.")
  (lane_l_y2 m))

(cl:ensure-generic-function 'lane_r_x1-val :lambda-list '(m))
(cl:defmethod lane_r_x1-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lane_r_x1-val is deprecated.  Use autoware_msgs-msg:lane_r_x1 instead.")
  (lane_r_x1 m))

(cl:ensure-generic-function 'lane_r_y1-val :lambda-list '(m))
(cl:defmethod lane_r_y1-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lane_r_y1-val is deprecated.  Use autoware_msgs-msg:lane_r_y1 instead.")
  (lane_r_y1 m))

(cl:ensure-generic-function 'lane_r_x2-val :lambda-list '(m))
(cl:defmethod lane_r_x2-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lane_r_x2-val is deprecated.  Use autoware_msgs-msg:lane_r_x2 instead.")
  (lane_r_x2 m))

(cl:ensure-generic-function 'lane_r_y2-val :lambda-list '(m))
(cl:defmethod lane_r_y2-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lane_r_y2-val is deprecated.  Use autoware_msgs-msg:lane_r_y2 instead.")
  (lane_r_y2 m))
