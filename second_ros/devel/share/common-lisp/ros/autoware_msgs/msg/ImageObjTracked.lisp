...
(cl:defclass <ImageObjTracked> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (rect_ranged
    :reader rect_ranged
    :initarg :rect_ranged
    :type (cl:vector autoware_msgs-msg:ImageRectRanged)
   :initform (cl:make-array 0 :element-type 'autoware_msgs-msg:ImageRectRanged :initial-element (cl:make-instance 'autoware_msgs-msg:ImageRectRanged)))
   (real_data
    :reader real_data
    :initarg :real_data
    :type (cl:vector cl:integer)
...
(cl:defmethod cl:initialize-instance :after ((m <ImageObjTracked>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageObjTracked)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ImageObjTracked> is deprecated: use autoware_msgs-msg:ImageObjTracked instead.")))
...
(cl:defmethod total_num-val ((m <ImageObjTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:total_num-val is deprecated.  Use autoware_msgs-msg:total_num instead.")
  (total_num m))

(cl:ensure-generic-function 'obj_id-val :lambda-list '(m))
(cl:defmethod obj_id-val ((m <ImageObjTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:obj_id-val is deprecated.  Use autoware_msgs-msg:obj_id instead.")
  (obj_id m))

(cl:ensure-generic-function 'rect_ranged-val :lambda-list '(m))
(cl:defmethod rect_ranged-val ((m <ImageObjTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:rect_ranged-val is deprecated.  Use autoware_msgs-msg:rect_ranged instead.")
  (rect_ranged m))

(cl:ensure-generic-function 'real_data-val :lambda-list '(m))
(cl:defmethod real_data-val ((m <ImageObjTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:real_data-val is deprecated.  Use autoware_msgs-msg:real_data instead.")
  (real_data m))

(cl:ensure-generic-function 'lifespan-val :lambda-list '(m))
(cl:defmethod lifespan-val ((m <ImageObjTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lifespan-val is deprecated.  Use autoware_msgs-msg:lifespan instead.")
  (lifespan m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ImageObjTracked>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'rect_ranged)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'autoware_msgs-msg:ImageRectRanged))
