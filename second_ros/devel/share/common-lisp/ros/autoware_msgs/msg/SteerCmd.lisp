...
(cl:defmethod cl:initialize-instance :after ((m <SteerCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SteerCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<SteerCmd> is deprecated: use autoware_msgs-msg:SteerCmd instead.")))
