...
(cl:defmethod cl:initialize-instance :after ((m <ControlCommandStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlCommandStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ControlCommandStamped> is deprecated: use autoware_msgs-msg:ControlCommandStamped instead.")))
