...
(cl:defmethod cl:initialize-instance :after ((m <LampCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LampCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<LampCmd> is deprecated: use autoware_msgs-msg:LampCmd instead.")))
