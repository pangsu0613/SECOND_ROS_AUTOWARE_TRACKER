...
(cl:defclass <TrafficLightResultArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (results
    :reader results
    :initarg :results
    :type (cl:vector autoware_msgs-msg:TrafficLightResult)
   :initform (cl:make-array 0 :element-type 'autoware_msgs-msg:TrafficLightResult :initial-element (cl:make-instance 'autoware_msgs-msg:TrafficLightResult))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLightResultArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLightResultArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<TrafficLightResultArray> is deprecated: use autoware_msgs-msg:TrafficLightResultArray instead.")))
...
(cl:defmethod results-val ((m <TrafficLightResultArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:results-val is deprecated.  Use autoware_msgs-msg:results instead.")
  (results m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrafficLightResultArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'results)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'autoware_msgs-msg:TrafficLightResult))
