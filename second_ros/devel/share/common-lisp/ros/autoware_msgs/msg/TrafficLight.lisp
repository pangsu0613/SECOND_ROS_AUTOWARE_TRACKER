...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLight>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLight)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<TrafficLight> is deprecated: use autoware_msgs-msg:TrafficLight instead.")))
