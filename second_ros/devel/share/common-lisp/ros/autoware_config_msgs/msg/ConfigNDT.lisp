...
(cl:defmethod cl:initialize-instance :after ((m <ConfigNDT>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigNDT)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_config_msgs-msg:<ConfigNDT> is deprecated: use autoware_config_msgs-msg:ConfigNDT instead.")))
