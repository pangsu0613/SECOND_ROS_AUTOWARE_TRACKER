...
(cl:defmethod cl:initialize-instance :after ((m <ConfigRcnn>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigRcnn)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_config_msgs-msg:<ConfigRcnn> is deprecated: use autoware_config_msgs-msg:ConfigRcnn instead.")))
...
(cl:defmethod slices_overlap-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:slices_overlap-val is deprecated.  Use autoware_config_msgs-msg:slices_overlap instead.")
  (slices_overlap m))

(cl:ensure-generic-function 'b_mean-val :lambda-list '(m))
(cl:defmethod b_mean-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:b_mean-val is deprecated.  Use autoware_config_msgs-msg:b_mean instead.")
  (b_mean m))

(cl:ensure-generic-function 'g_mean-val :lambda-list '(m))
(cl:defmethod g_mean-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:g_mean-val is deprecated.  Use autoware_config_msgs-msg:g_mean instead.")
  (g_mean m))

(cl:ensure-generic-function 'r_mean-val :lambda-list '(m))
(cl:defmethod r_mean-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:r_mean-val is deprecated.  Use autoware_config_msgs-msg:r_mean instead.")
  (r_mean m))

(cl:ensure-generic-function 'image_slices-val :lambda-list '(m))
(cl:defmethod image_slices-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:image_slices-val is deprecated.  Use autoware_config_msgs-msg:image_slices instead.")
  (image_slices m))

(cl:ensure-generic-function 'use_gpu-val :lambda-list '(m))
(cl:defmethod use_gpu-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:use_gpu-val is deprecated.  Use autoware_config_msgs-msg:use_gpu instead.")
  (use_gpu m))

(cl:ensure-generic-function 'gpu_device_id-val :lambda-list '(m))
(cl:defmethod gpu_device_id-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:gpu_device_id-val is deprecated.  Use autoware_config_msgs-msg:gpu_device_id instead.")
  (gpu_device_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigRcnn>)))
  ...
  "autoware_config_msgs/ConfigRcnn")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigRcnn)))
  "Returns string type for a message object of type 'ConfigRcnn"
  "autoware_config_msgs/ConfigRcnn")
