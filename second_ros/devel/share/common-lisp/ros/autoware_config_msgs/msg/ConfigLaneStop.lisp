...
(cl:defmethod cl:initialize-instance :after ((m <ConfigLaneStop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigLaneStop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_config_msgs-msg:<ConfigLaneStop> is deprecated: use autoware_config_msgs-msg:ConfigLaneStop instead.")))
...
(cl:defmethod manual_detection-val ((m <ConfigLaneStop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:manual_detection-val is deprecated.  Use autoware_config_msgs-msg:manual_detection instead.")
  (manual_detection m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigLaneStop>)))
  ...
  "autoware_config_msgs/ConfigLaneStop")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigLaneStop)))
  "Returns string type for a message object of type 'ConfigLaneStop"
  "autoware_config_msgs/ConfigLaneStop")
