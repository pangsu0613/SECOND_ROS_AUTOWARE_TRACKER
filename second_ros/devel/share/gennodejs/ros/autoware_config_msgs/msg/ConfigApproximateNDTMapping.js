...
class ConfigApproximateNDTMapping {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('max_submap_size')) {
        this.max_submap_size = initObj.max_submap_size
      }
      else {
        this.max_submap_size = 0.0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [max_submap_size]
    bufferOffset = _serializer.float32(obj.max_submap_size, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ConfigApproximateNDTMapping(null);
    ...
    // Deserialize message field [max_submap_size]
    data.max_submap_size = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ConfigApproximateNDTMapping(null);
    ...
    if (msg.max_submap_size !== undefined) {
      resolved.max_submap_size = msg.max_submap_size;
    }
    else {
      resolved.max_submap_size = 0.0
    }
...
module.exports = ConfigApproximateNDTMapping;
