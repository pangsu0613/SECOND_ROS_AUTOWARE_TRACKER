...
class ConfigPedestrianFusion {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ConfigPedestrianFusion(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ConfigPedestrianFusion(null);
...
module.exports = ConfigPedestrianFusion;
