...
"""autogenerated by genpy from lgsvl_msgs/BoundingBox2D.msg. Do not edit."""
import sys
...
class BoundingBox2D(genpy.Message):
  ...
  _type = "lgsvl_msgs/BoundingBox2D"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float32 x  # x position of the bounding box center in camera image space, in pixels
