...
class ConfigTwistFilter(genpy.Message):
  _md5sum = "335a86e776e694c10602a1ee3d9a09de"
...
string frame_id
"""
  __slots__ = ['header','lateral_accel_limit','lowpass_gain_linear_x','lowpass_gain_angular_z']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,lateral_accel_limit,lowpass_gain_linear_x,lowpass_gain_angular_z
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3f().pack(_x.lateral_accel_limit, _x.lowpass_gain_linear_x, _x.lowpass_gain_angular_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.lateral_accel_limit, _x.lowpass_gain_linear_x, _x.lowpass_gain_angular_z,) = _get_struct_3f().unpack(str[start:end])
      return self
